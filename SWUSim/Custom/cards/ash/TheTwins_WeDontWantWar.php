...
$whenPlayedAbilities["ASH_127:0"] = $onAttackAbilities["ASH_127:0"] = function($player, $mzID) {
    SWUOfferUnitTarget($player, $mzID, ['continuation'=>'GRANT_PHASE_KEYWORD|ASH_127', 'side'=>'friendly', 'excludeSelf'=>true, 'may'=>true, 'question'=>"Give_another_friendly_unit_Sentinel_this_phase?", 'prompt'=>"Choose_a_unit"]);
};
