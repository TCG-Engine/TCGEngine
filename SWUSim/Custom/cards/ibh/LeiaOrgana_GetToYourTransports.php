...
$onAttackAbilities["IBH_001:0"] = function($player, $mzID) {
    SWUOfferUnitTarget($player, $mzID, ['continuation'=>'IBH_001#0','side'=>'friendly','may'=>true,
...
$customDQHandlers["IBH_001#0"] = function ($player, $parts, $lastDecision) {
  ...
  SWUOfferUnitTarget($player, '', ['continuation'=>'HEAL_TARGET','amount'=>1,'side'=>'friendly','excludeUID'=>$firstUID,
