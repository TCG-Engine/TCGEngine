...
// TS26_05 Savage Opress (front, undeployed) — "Each friendly unit with the most power among friendly
...
function _SWUSavageFrontGrants($obj): bool {
    ...
    foreach (GetLeader($ctrl) as $l) {
        if (($l->CardID ?? '') === 'TS26_05' && empty($l->Deployed)) { $undeployed = true; break; }
    }
...
function GetConditionalKeyword_Raid_Value($obj) {
    ...
    // vice versa". The PLAYER CHOOSES the direction (user ruling 2026-09-08); the delta subtracts the
