...
#// (not an enemy base) and the attacker is not friendly to P1 — so no Force for either player. Ref: "should
...
#// spills to P2's base as combat damage (>= 3) → P1 gains the Force. Ref: "should give the Force when a
