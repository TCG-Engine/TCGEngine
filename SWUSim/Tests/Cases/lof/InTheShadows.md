...
#// Hidden LOF_132 units stay 3/4 with no upgrades. Ref: "should allow you to choose nothing."
...
#// Experience to both Hidden units incl. the space one; the Jedi Knight is excluded. Ref: "should give
