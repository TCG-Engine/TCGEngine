...
#// (myTempZone-0) is selectable. Ref: "assert we can only select the friendly upgrade on a friendly unit."
...
#// are eligible. Ref: "Make sure yoda is not selectable ... and so is jocasta as she's just been played."
