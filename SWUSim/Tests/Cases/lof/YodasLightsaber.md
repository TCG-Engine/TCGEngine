...
#// Force and heals the enemy base (3 → 0). Ref: "should heal enemy base".
...
#// healed (own base stays at 5 damage), and the saber remains attached. Ref: "decides not to use the
#// Force".
...
#// no heal (own base stays at 5), the saber still attaches. Ref: "doesn't have the Force".
...
#// enemy unit carries the saber; the friendly host does not. Ref: allows attaching to an enemy unit.
