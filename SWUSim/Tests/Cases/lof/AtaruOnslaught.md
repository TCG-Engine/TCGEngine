...
#// so it is not a valid target; the card discards with no prompt. Ref: "should skip target
...
#// and is readied while the other two stay exhausted. Ref: "should ready a Force unit with 4 or less
