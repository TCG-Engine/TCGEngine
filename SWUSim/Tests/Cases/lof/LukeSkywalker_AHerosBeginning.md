...
#// Battlefield Marine (SOR_095) does not trigger: no prompt, Force retained, Luke gains nothing. (FT: "should
...
#// unit. P1 plays the unique Owen Lars (LOF_057) without the Force; no prompt, Luke gains nothing. (FT:
#// "should not trigger if player does not have the Force".)
...
#// the Force. (FT: "should not trigger when opponent plays unique unit".)
