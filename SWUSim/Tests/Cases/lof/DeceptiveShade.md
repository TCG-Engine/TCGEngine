...
#// Resupply (SOR_126, an event); the next UNIT (SOR_095) still gains Ambush. (FT: "gives Ambush to the next
...
#// the turn passes to P2, who plays Battlefield Marine (SOR_095) — it does NOT gain Ambush. (FT: "does not
...
#// plays in the NEW phase (SOR_095) does NOT gain Ambush. (FT: "the effect expires at the end of the phase".)
...
#// Ambush. (FT: "does not give Ambush to deployed leader units".)
...
#// gain Ambush. (FT: "does not give Ambush to friendly units played after the next unit played this phase".)
...
#// P2's: P1's next unit (SOR_095) gets NO Ambush, but P2's next unit (Wampa SOR_164) DOES. (FT: "if defeated
...
#// gains Ambush. (Ref: "gives ambush to the next unit, even if a piloting upgrade is played in between.")
## GIVEN
CommonSetup: ggw/rrk/{myResources:8;theirBase:SOR_021}
P1OnlyActions: true
WithP1GroundArena: LOF_180:1:0
