...
#// The Daughter and uses the Force to heal 2, so the net damage to P2's base is 0. Ref: "heal 2 ... (from an
#// event)".
...
#// P2 keeps the Force, and The Daughter simply takes 2. Ref: "not allow ... when damage is dealt to unit".
...
#// Raid at P1's base; P2 keeps the Force and P1's base takes the full 2. Ref: "not allow ... when damage is
