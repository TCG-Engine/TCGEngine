...
#// played nothing this phase; using the ability exhausts Rey and deals no damage. (FT: "should only have an
...
#// Rey to deal 1 damage to her own Plo Koon (LOF_050). (FT: "should damage a unit if a Force event card was
...
#// (FT: "should not be able to damage a unit as a Force unit card was played".)
...
#// uses Rey and it has no effect (Plo Koon shows only Drain Essence's 2 damage, no extra 1). (FT: "should not
...
#// hand P1 still triggers: discards 0, draws 2 from a 3-card deck → hand 2, deck 1, discard 0. (FT: "should
...
#// discarded, and the deck (3) is not drawn from. (FT: "should be able to pass discard and draw two cards
#// ability".)
