...
#// and only its own 1-cost is spent (myResources:7 → 6 available). Ref: "should allow paying up to 6
...
#// left. Ref: "should allow paying up to 6 resources (but max is 3)" (range 0-2).
