...
#// token. Intended: "should not give -2/-0 to the attacker if the Force is not used."
...
#// attacks Chirrut (3/5) and deals the full 3; Chirrut counters for 3. Intended: "should not prompt the user if
...
# AttackerDebuff_ExpiresAfterTheAttack
#// LOF_067 Chirrut Îmwe — the -2/-0 is "FOR THIS ATTACK". P1's Consular Security Force (3/7) attacks
#// Chirrut, P2 spends the Force so only 1 damage lands — and once the attack is over the attacker is
#// back to its printed 3 power rather than staying debuffed for the phase.
## GIVEN
CommonSetup: rrk/ggw
P1OnlyActions: true
WithP2Force: true
