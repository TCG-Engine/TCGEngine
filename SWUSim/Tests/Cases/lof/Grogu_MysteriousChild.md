...
#// is then dealt. P1 heals its SOR_046 (1 damage → 0) and deals that 1 to the enemy SEC_080. Ref: "should heal
...
#// Ref: "should not heal damage from a unit and should not deal damage to a unit" (distribute 0).
