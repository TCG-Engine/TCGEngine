...
#// not 1 + 4. Ref: "does not double the raid value of enemy units."
...
#// Ref: "doubles Marchion Ro's own raid value."
...
#// 5 → 3. Ref: "does not double other numeric keywords."
...
#// Ref: "applies the multiplier after all stacked raid effects."
