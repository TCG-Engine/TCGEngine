...
#// TS26_007 Asajj Ventress (leader deployed, 3/5) — Hidden + "While you've attacked with a token unit this
#// phase, this unit gets +2/+0." After the Battle Droid token attacks, deployed Asajj is 5 power.
## GIVEN
CommonSetup: yyk/rrk/{myLeader:TS26_007:1:1}
SkipPreGame: true
P1OnlyActions: true
...
## EXPECT
P1GROUNDARENAUNIT:1:CARDID:TS26_007
