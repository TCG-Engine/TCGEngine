    ...
    $.get('../Stats/DeckMetaStatsAPI.php', params, function(data) {
      ...
      for (var i=0; i<json.length; ++i) {
        ...
        rows += '<td style="white-space:nowrap;gap:6px;align-items:stretch;">'
          + '<a href="https://swustats.net/TCGEngine/Stats/Decks.php?leader=' + r.leaderID + '&base=' + r.baseID + '" style="margin-right:10px; display:inline-flex; align-items:center; vertical-align:middle;">'
