...
$_SERVER['HTTP_HOST'] = 'petranaki.net';
discordAuthCheck('Petranaki uses its own Discord callback', DiscordOAuthConfig()['redirectUri'] === 'https://petranaki.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'www.petranaki.net';
discordAuthCheck('the callback keeps the requested www host', DiscordOAuthConfig()['redirectUri'] === 'https://www.petranaki.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'clarent.net:8443';
discordAuthCheck('the callback drops the request port', DiscordOAuthConfig()['redirectUri'] === 'https://clarent.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'SoulMastersDB.net';
discordAuthCheck('the callback host is case-insensitive', DiscordOAuthConfig()['redirectUri'] === 'https://soulmastersdb.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'swustats.net';
discordAuthCheck('SWUStats keeps its registered www callback', DiscordOAuthConfig()['redirectUri'] === 'https://www.swustats.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'www.swustats.net';
discordAuthCheck('the SWUStats www callback is unchanged', DiscordOAuthConfig()['redirectUri'] === 'https://www.swustats.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'deck.swustats.net';
discordAuthCheck('a SWUStats subdomain keeps the www callback', DiscordOAuthConfig()['redirectUri'] === 'https://www.swustats.net/TCGEngine/APIs/DiscordLogin.php');
$_SERVER['HTTP_HOST'] = 'petranaki.net.evil.example';
discordAuthCheck('a lookalike host cannot claim a callback', DiscordOAuthConfig()['redirectUri'] === 'https://www.swustats.net/TCGEngine/APIs/DiscordLogin.php');
