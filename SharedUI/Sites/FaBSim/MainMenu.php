...
<main class="fab-home">
  ...
  <div class="fab-menu-grid">
    ...
    <section class="fab-panel" aria-labelledby="fab-play-title">
      ...
      <label for="fab-bot-profile">Bot opponent</label><select id="fab-bot-profile" style="width:100%;padding:8px;margin:6px 0 10px;background:#172428;color:#eee;border:1px solid #56605a;border-radius:6px"><option value="fai">Fai</option><option value="ira">Ira · Crouching Tiger</option><option value="boltyn">Boltyn · Light Warrior</option><option value="maxx">Maxx &middot; Armory Deck (60 cards)</option><option value="uzuri">Uzuri · Stealth</option><option value="arakni">Arakni · Contracts</option><option value="dromai">Dromai · Ashwing Swarm</option><option value="lexi">Lexi · Elemental Ranger</option><option value="prism">Prism · Illusionist</option><option value="levia">Levia · Shadow Brute</option><option value="professor">Professor Teklovossen</option></select>
      <div class="fab-modes">
