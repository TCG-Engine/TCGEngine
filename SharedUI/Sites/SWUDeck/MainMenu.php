  ...
  foreach ($decks as $deck) {
    if($deck["assetStatus"] == 1) { // Check if it's deleted
      ...
      if (!empty($deck["keyIndicator1"])) {
        $thisDeck .= "<img src='../SWUDeck/concat/" . $deck["keyIndicator1"] . ".webp' style='height: 80px;' title='" . CardTitle($deck["keyIndicator1"]) . "' />";
      } else {
        $thisDeck .= "No Leader";
      }
      $thisDeck .= "</td>";
      ...
      if (!empty($deck["keyIndicator2"])) {
        $thisDeck .= "<img src='../SWUDeck/concat/" . $deck["keyIndicator2"] . ".webp' style='height: 80px;' title='" . CardTitle($deck["keyIndicator2"]) . "' />";
      } else {
        $thisDeck .= "No Base";
      }
      $thisDeck .= "</td>";
...
<div class="pageContainer" style="min-height:100vh; display:flex; flex-direction:column;">
  <div class="core-wrapper">
    <div class="mobile-layout">
      <!-- Card Search Section - Will be displayed first on mobile -->
      <div class="search-section login container bg-black">
      ...
      <!-- Deck List Section - Will be displayed second on mobile -->
      <div class="decks-section tabs" style="width: 70%; margin: 0 auto; margin-left:20px;">
      <style>
    ...
    <!-- News Section - Will be displayed last on mobile -->
    <div class="news-section login container bg-black">
      <h2>Record stats no matter where you play!</h2>
      <p class="login-message">Now you can add stats to your decks no matter how you play! Click the Add Stats button on the stats screen!</p>
      <p class="login-message">You can now add our new Discord bot to your server by clicking <a href="https://discord.com/oauth2/authorize?client_id=1338995198730043432&permissions=2147600384&integration_type=0&scope=bot+applications.commands" target="_blank">this link</a>.</p>
    </div>
  </div> <!-- Close mobile-layout div -->
