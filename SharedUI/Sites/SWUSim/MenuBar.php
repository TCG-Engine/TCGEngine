...
<body>
  ...
  <div class='nav-bar'>
    ...
    <div class='nav-bar-links'>
      <ul>
          <?php
            echo '<li><a target="_blank" href="https://discord.gg/b9nfNyVFpM" title="Petranaki Arena Development Server"><img src="/TCGEngine/Assets/Images/icons/discord.svg"></img></a></li>';
