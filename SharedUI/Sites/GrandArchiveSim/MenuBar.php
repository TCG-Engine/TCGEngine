...
<head>
  ...
  <link rel="stylesheet" href="./css/gudnakMenuStyles.css">
...
<body>
  ...
  <div class='nav-bar'>
    ...
    <div class='nav-bar-links'>
      <ul>
          <?php
            echo '<li><a target="_blank" href="https://discord.gg/gudnak" title="Gudnak Community Discord"><img src="../Assets/Images/icons/discord.svg"></img></a></li>';
          ?>
      </ul>
    </div>
