...
Azuki Sim is in no way affiliated with Azuki TCG. Azuki TCG characters, cards, logos, and art are property of Azuki TCG.
<br><br>
Azuki Sim is a fan-made deck building and stat-tracking site for the Azuki TCG created by Azuki TCG.</a>.
<br><br>
...
<h2>Account Data</h2>
When you create an account on Azuki Sim, you provide a username, email, and password. This data is stored in a database. Your password is hashed before being stored. Your email is used to send you a verify ownership of the account if necessary. Your username is used to identify you on the site.

<h2>Deck Data</h2>
When you create a deck on Azuki Sim, you provide a name for the deck and a list of cards. This data is stored in files on the server and in a database. An internal identifier is automatically created to uniquely identify the deck. The deck name is a convenience for you to identify the deck. The list of cards is used to display the deck and calculate statistics.

<h2>Usage Data</h2>
When you use Azuki Sim, data is collected about your usage of the site. This data includes the pages you visit, the actions you take, and the time you spend on the site. This data is used to improve the site and to provide you with a better experience.
...
Azuki Sim reserves the right to modify this Privacy Policy at any time. Changes will be posted on this page, and your continued use of the site constitutes acceptance of the updated policy.
