...
fwrite($handler, "include '../Core/GameAuth.php';\r\n");
...
fwrite($handler, "  exit;\r\n");
fwrite($handler, "}\r\n");
fwrite($handler, "if(!\$viewerInfo[\"isSpectator\"] && !SimGameValidateSeatAuth('" . $rootName . "', \$gameName, \$viewerInfo[\"viewerSeat\"], \$authKey)) {\r\n");
