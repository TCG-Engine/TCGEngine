...
def build_content(doc):
    ...
    add_bullet(doc, "Core/jsInclude.js and Core/UILibraries20260728.js: current browser action serialization, decision UI, chat behavior, and zone rendering conventions.")
