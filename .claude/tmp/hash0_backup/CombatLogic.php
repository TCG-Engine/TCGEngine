...
function SWUDefeatUnit($player, $unitMzID, $skipReplacement = false) {
...
function SWUDefeatUpgrade(int $player, string $hostMzID, int $upgradeIndex = 0, bool $bounce = false, bool $skipReplacement = false): bool {
    ...
    // SOR_122 Traitorous: when this upgrade is defeated, its host returns to owner.
    if ($foundCardID === 'SOR_122') {
