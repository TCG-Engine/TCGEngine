...
?>
  <head>
    ...
    <script src="./Core/UILibraries20260831.js?v=<?php echo filemtime('./Core/UILibraries20260831.js'); ?>"></script>
...
<?php   }
  ...
  <body onkeydown='Hotkeys(event)' onload='OnLoadCallback(<?php echo ($initialGamestateUpdateMarker); ?>)'>
          ...
          try {
            ...
            if (_goVars && _goVars.GAMEOVER_WINNER) {
              ...
              if (_goWinner > 0 && typeof ShowGameOver === 'function') {
                ...
                // Match-enabled sims: show the match-aware end-game menu (contextual buttons + the
                ...
                } else if (typeof window.AzukiShowEndGameMenu === 'function') {
                  window.AzukiShowEndGameMenu(_goStatsHtml, _goWinner);
                } else {
    ...
    <div id='chatWidget' style='z-index:40; position:fixed; bottom:20px; left:140px; display:flex; flex-direction:column; align-items:flex-start; width:320px; max-width:calc(100vw - 156px);'>
        ...
        <?php if (!in_array($folderPath, ['AzukiSim', 'SWUSim', 'HellbreakSim'], true)): ?>
