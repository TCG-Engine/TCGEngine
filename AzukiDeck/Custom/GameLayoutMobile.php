<?php
// GameLayoutMobile.php â€” AzukiDeck phone layout.
//
...
<style>
  ...
  /* The same shallow leader-unit/gate treatment used by the desktop editor. It remains
  ...
  #swuDeckMobileIdentity #myGateSlot,
  ...
  #swuDeckMobileIdentity #myLeaderSlot,
  #swuDeckMobileIdentity #myGateSlot { z-index: 3; }
  #swuDeckMobileIdentity #myLeaderSlot > *,
  #swuDeckMobileIdentity #myGateSlot > * { visibility: hidden !important; }
  ...
  #swuDeckMobileIdentity #myGateWrapper,
  #swuDeckMobileIdentity #myLeader,
  #swuDeckMobileIdentity #myGate,
...
<div id="swuDeckMobileRoot" data-pane="search">
  ...
  <div id="swuDeckMobileIdentity" aria-label="Deck leader and gate">
    ...
    <div id="myGateSlot" onclick="ZoneClickHandler('myGate');"></div>
  </div>
...
(function(){
  ...
  window.AzukiDeckMobileSetPane = setPane;
  ...
  function enhanceIdentity(){
    ...
    useIdentityCrop('myGateSlot', 'swuMobileBaseArt', false);
  }
...
(function(){
  ...
  window.AzukiDeckViewportDiagnostics = function(){
  ...
  function copyDiagnostics(){
    ...
    var text = JSON.stringify(window.AzukiDeckViewportDiagnostics(), null, 2);
